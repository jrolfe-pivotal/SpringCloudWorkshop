...
+
----
$ cf push -n scale-XX  // Replace XX with something unique, like your name
----

. Remember that an application's routes can be seen by using `cf apps` or by examining the application from the Apps Manager UI.
